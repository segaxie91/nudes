...
export default {
    //ctlPanel
    ctlPanelBgColor: defaultColor,

    //CtlRow
    ctlRowColor: defaultColor,
    ctlRowHeight: 30,

    //XItemRow
    xItemRowPaddingLeft: 3,
    xItemRowPaddingRight: 8,
    xItemRowPaddingTop: 5,
    xItemRPaddingBottom: 5,

    //ctlButton
    ctlBtnBorderColor: primaryColor,
    ctlBtnBgColor: defaultColor,
    ctlBtnFontSize: 18,
